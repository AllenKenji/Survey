...
export default function Dashboard() {
  ...
  const handleExportReport = () => {
    ...
    exportToPDF(`${selectedLocation || "Province"} Report`, summaryHeaders, summaryRows, "report");
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold tracking-tight text-foreground">
            {selectedLocation ? `${selectedLocation} Overview` : "Dashboard Overview"}
          </h2>
          <p className="text-muted-foreground mt-1">
            Real-time insights for the Cagayano Family Development Program.
          </p>
        </div>
